...
public class TC_008_SO_Bulk_Duplicate_SKU_CSV extends BaseUtilityClass {
	...
	public void SO_Bulk_Duplicate_SKU_CSV_Test() throws Throwable {
		...
		getCommonAction().get_SO_Bulk_Duplicate_CSV();
		...
		getCommonAction().checkAssertString_Empty(SO_Number, "Validation of SO_Bulk_Duplicate_SKU_CSV_Test");
